...
14. [Humidity control](documentation/en/feature-humidity.md)
15. [Auto start and stop](documentation/en/feature-auto-start-stop.md)
16. [Centralized control of all VTherms](documentation/en/feature-central-mode.md)
17. [Central heating control](documentation/en/feature-central-boiler.md)
18. [Advanced aspects, security mode](documentation/en/feature-advanced.md)
19. [Self-regulation](documentation/en/self-regulation.md)
20. [Tuning examples](documentation/en/tuning-examples.md)
21. [Algorithms](documentation/en/algorithms.md)
22. [Lock / Unlock](documentation/en/feature-lock.md)
23. [Reference documentation](documentation/en/reference.md)
