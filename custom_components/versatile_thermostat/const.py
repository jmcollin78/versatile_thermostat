...
CONF_HUMIDITY_MODE = "humidity_control_mode"
CONF_HUMIDITY_MODE_OFF = "humidity_control_off"
CONF_HUMIDITY_MODE_DRY_ONLY = "humidity_control_dry_only"
CONF_HUMIDITY_MODE_COOL_ASSIST = "humidity_control_cool_assist"
CONF_HUMIDITY_MODES = [
    CONF_HUMIDITY_MODE_OFF,
    CONF_HUMIDITY_MODE_DRY_ONLY,
    CONF_HUMIDITY_MODE_COOL_ASSIST,
]
CONF_HUMIDITY_TARGET = "target_humidity"
CONF_HUMIDITY_TOLERANCE = "humidity_tolerance"
CONF_HUMIDITY_SAFETY_DELAY_MIN = "humidity_safety_delay_min"
...
HVAC_OFF_REASON_HUMIDITY_TARGET_REACHED = "hvac_off_humidity_target_reached"
...
DEFAULT_HUMIDITY_STEP = 1
DEFAULT_HUMIDITY_TOLERANCE = 3
DEFAULT_HUMIDITY_SAFETY_DELAY_MIN = 60
DEFAULT_HUMIDITY_COOLING_TEMPERATURE_TOLERANCE = 0.2
