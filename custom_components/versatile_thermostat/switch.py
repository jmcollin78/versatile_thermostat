...
class AutoStartStopEnable(VersatileThermostatBaseEntity, SwitchEntity, RestoreEntity):
    ...
    def __init__(
        ...
        self._attr_unique_id = gen_attr_uniq_id(unique_id, entry_infos, "enable_auto_start_stop")
...
class FollowUnderlyingTemperatureChange(
    ...
    def __init__(
        ...
        self._attr_unique_id = gen_attr_uniq_id(unique_id, entry_infos, "follow_underlying_temp_change")
        self._attr_is_on = False
        self._attr_entity_category = EntityCategory.CONFIG
