...
STEP_TPI_DATA_SCHEMA = vol.Schema(  # pylint: disable=invalid-name
    {
        ...
        # vol.Optional(CONF_AUTO_TPI_MODE, default=False): cv.boolean, # Moved to TPI Attributes to be visible even if central config is used
    }
)
...
STEP_AUTO_TPI_1_SCHEMA = vol.Schema(
    {
        ...
        vol.Required(CONF_AUTO_TPI_HEATING_POWER, default=0): cv.positive_float,
        vol.Required(CONF_AUTO_TPI_COOLING_POWER, default=0): cv.positive_float,
        vol.Required(CONF_AUTO_TPI_MAX_COEF_INT, default=0.9): selector.NumberSelector(
            selector.NumberSelectorConfig(
...
STEP_AUTO_TPI_3_EMA_SCHEMA = vol.Schema(
    {
        vol.Required(CONF_AUTO_TPI_EMA_ALPHA, default=0.2): selector.NumberSelector(
            selector.NumberSelectorConfig(
