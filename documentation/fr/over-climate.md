...
1. l'auto-start/stop : arrêt et démarrage automatique de l'équipement sous-jacent selon la prévision d'usage (le _VTherm_ conserve le `hvac_mode` demandé). Elle est décrite ici fonction [auto-start/sop](feature-auto-start-stop.md),
