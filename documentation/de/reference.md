...
| ``hvac_off_reason``                             | Gibt den Grund für die Abschaltung von VTherm (hvac_off) an. Mögliche Werte sind "Fenster", "Automatischer Start/Stopp", "Manuell" oder "Ruhemodus".                                                                              |
...
| ``is_sleeping``                                 | Zeigt an, dass sich der VTherm im Ruhemodus befindet (gilt für `over_climate` mit direkter Ventilsteuerung und `over_valve`)                                                                                                      |
