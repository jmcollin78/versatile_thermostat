...
Znalezienie odpowiednich współczynników (`tpi_coef_int` i `tpi_coef_ext`) jest często skomplikowane i wymaga wielu prób. Od teraz **Auto TPI zrobi to za Ciebie.**
