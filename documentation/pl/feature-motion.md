...
> 1. Podobnie jak w przypadku innych ustawień wstępnych, `aktywność` będzie dostępna tylko wtedy, gdy zostanie poprawnie skonfigurowana. Oznacza to, że wszystkie 4 kluczowe parametry muszą być ustawione.
