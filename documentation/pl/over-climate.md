...
> 1. AutoSTART/autoSTOP: Automatyczne uruchamianie i zatrzymywanie urządzenia podrzędnego na podstawie prognoz użytkowania (termostat _VTherm_ zachowuje przy tym żądany `hvac_mode`). Opis znajduje się [tutaj](feature-auto-start-stop.md).
