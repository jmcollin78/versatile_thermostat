...
Presety konfigurowane są bezpośrednio z encji _VTherm_ lub z konfiguracji centralnej, jeśli korzystasz ze scentralizowanego sterowania. Po utworzeniu termostatu będziesz mieć do dyspozycji różne encje umożliwiające ustawienie temperatur osobno dla każdego presetu:
...
>
> 1. Gdy ręcznie zmienisz temperaturę docelową, preset przełączy się na `Brak`.
