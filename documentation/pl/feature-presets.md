...
> 4. Jeśli korzystasz z zaawansowanej konfiguracji, zobaczysz preset `bezpieczeństwo`, jeśli temperatura nie mogła zostać pobrana w określonym czasie. Zobacz: [tryb bezpieczeństwa](feature-advanced.md#safety-mode).
