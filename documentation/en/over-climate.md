...
1. Auto-Start/Stop: Automatic start and stop of the underlying device based on usage forecasts (the _VTherm_ keeps the requested `hvac_mode`). This is described here: [auto-start/stop function](feature-auto-start-stop.md).
