...
async def test_cycle_scheduler_cancel_on_remove(
    ...
    mock_tick_unsub = MagicMock()
    mock_cycle_end_unsub = MagicMock()
    scheduler._tick_unsub = mock_tick_unsub
    scheduler._cycle_end_unsub = mock_cycle_end_unsub
    ...
    mock_cycle_end_unsub.assert_called_once()
