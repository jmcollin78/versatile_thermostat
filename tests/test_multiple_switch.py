...
async def test_multiple_climates(
    ...
    entry = MockConfigEntry(
        ...
        data={
            ...
            CONF_CLIMATE_7: "switch.mock_climate7",
            CONF_CLIMATE_8: "switch.mock_climate8",
            CONF_CLIMATE_9: "switch.mock_climate9",
            CONF_MINIMAL_ACTIVATION_DELAY: 30,
            CONF_SECURITY_DELAY_MIN: 5,
            CONF_SECURITY_MIN_ON_PERCENT: 0.3,
        },
    ...
    assert entity.nb_underlying_entities == 9
    ...
    with patch(
        ...
        # Should be call for all Switch
        assert mock_underlying_set_hvac_mode.call_count == 9
        mock_underlying_set_hvac_mode.assert_has_calls(
            [
                call.set_hvac_mode(HVACMode.HEAT),
            ]
